...
@Component({
  selector: 'app-relatorio-atrasos',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './relatorio-atrasos.component.html',
  styleUrls: ['./relatorio-atrasos.component.scss']
})
export class RelatorioAtrasosComponent {
  meses: string[] = [
  ...
  buscarRelatorio() {
    console.log('Buscar relatório de atrasos', this.selectedMes, this.selectedAno);
  }
}
